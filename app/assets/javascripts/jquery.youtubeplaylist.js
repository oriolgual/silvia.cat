...
jQuery.fn.ytplaylist = function(options) {
	...
	return this.each(function() {
		...
		function playNew (id, title, description) {
			var html = '';
      ...
      var description = jQuery(this).data("description");
			if(options.showInline) {
				...
				jQuery(this).parent("li").addClass("currentvideo").html(playNew(jQuery(this).data("yt-id"), title, description));
			}
			else {
				jQuery("#"+options.holderId+"").html(playNew(jQuery(this).data("yt-id"), title, description));
		...
		if(options.addThumbs) {
			...
			$el.children().each(function(i){
				...
				var replacedText = jQuery.trim(jQuery(this).text());
				var thumbUrl;
